...
# Акцессоры - чтобы можно было узнать координаты снаружи
  attr_accessor :x, :y, :n
# Конструктор, принимает хеш. Если не задан - будет пустой хеш.
# В хеше мы ожидаем три параметра - начальные координаты робота,
# если не заданы, будут по-умолчанию равны нулю и номер робота, если не задан по по умолчанию будет
