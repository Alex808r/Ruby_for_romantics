...
Задание: чтобы статистика была более наглядной, добавьте в программу выше вывод
двух массивов.

Задание: вместо бинарного значения ноль или единица пусть каждый робот имеет
...
def attack(arr)
  ...
  if arr[i] > 0
    arr[i] -= f
    puts "Робот по индексу #{i} потерял #{f} процентов"
  else
    puts "Промазали по индексу #{i}"
  end
  sleep 1 # еще один sleep для красоты вывода
